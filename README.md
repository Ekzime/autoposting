...
### 🐳 Docker установка (рекомендуется для продакшена)

Для развертывания на VPS или продакшен-сервере используйте Docker:

📋 **Подробная инструкция по Docker установке находится в [`docker/README.md`](docker/README.md)**
...
PROMO_CRYPTO_URL=https://t.me/                        # URL крипто-канала
PROMO_FOREX_TEXT=Форекс.                              # Текст для форекс-канала
PROMO_FOREX_URL=https://t.me/                         # URL форекс-канала
PROMO_NEWS_TEXT=Новости.                              # Текст для новостного канала
PROMO_NEWS_URL=https://t.me/                         # URL новостного канала
```
